              ...
              <div className="space-y-3 text-sm">
                ...
                {(product.availability || soldOut) && (
                  <div className="flex items-center">
                    ...
                    <span className={`flex-1 flex items-center gap-2 ${soldOut ? 'text-[#B23A48]' : 'text-[#388E3C]'}`}>
                      <Package className="w-4 h-4" /> {soldOut ? 'Out of Stock' : product.availability}
                    </span>
                  </div>
                )}
              </div>
            ...
            {soldOut ? (
              <div className="space-y-4" data-testid="sold-out-block">
                ...
                <p className="text-sm text-[#666666] text-center">
                  This piece is currently sold out. Message us on WhatsApp and we'll let you
                  know as soon as it's back in stock.
                </p>
                <a
                  href={`https://wa.me/917310768702?text=${encodeURIComponent(
